		...
		try 
		{
			...
			if(status==false) {
				...
				if(count<4) {
					...
					System.out.println("\nYou have successfully registered for Course : " + courseCode);
					
				}
				
				else {
					System.out.println(ConsoleColors.RED + "\nCan't register for more than 4 courses." + ConsoleColors.RESET);
				}
				
			}
			
			else {
				System.out.println(ConsoleColors.RED + "\nFees already paid. You cannot change the courses." + ConsoleColors.RESET);
			}
