...
public class SQLQueriesConstant {
		...
		public static final String IS_STUDENT_ID_PRESENT="select * from student where studentId = ?";
		public static final String NOTIFICATION="select max(notificationId) from notification";
		public static final String SETNOTIFICATION="insert into Notification(notificationId,StudentId,type) values (?, ?, ?) ";
		public static final String NETBANKING="insert into netbanking(referenceId,ifsccode,accountnumber) values (?, ?, ?) ";
		public static final String CHEQUE="insert into cheque(referenceId,chequenumber) values (?, ?) ";
		public static final String CARD="insert into card(referenceId,cardnumber,cardtype) values (?, ?, ?) ";
		public static final String GETFEES="select sum(course.courseFee) from course join registeredcourse where course.courseCode = registeredcourse.coursecode and studentid = ? ";
		...
		public static final String INSERT_PAYMENT = "insert into payment(referenceId,studentId,modeofPayment,amount) values(?,?,?,?);";
		public static final String INSERT_NOTIFICATION = "insert into notification(notificationID,studentId,type) values(?,?,?);";
		...
		public static final String SET_REPORT_STATUS="update student set isReportGenerated = true  where studentId=?";
